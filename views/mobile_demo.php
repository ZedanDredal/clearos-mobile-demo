...
<p>The source code for both the Android™ and Webconfig applications is publicly available from the ClearFoundation <a href="http://www.clearfoundation.com/docs/developer/source_code/">SVN server</a>.</p>
<ul>
